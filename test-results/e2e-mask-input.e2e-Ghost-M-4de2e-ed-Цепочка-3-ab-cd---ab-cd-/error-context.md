...
- Name: e2e/mask-input.e2e.spec.js >> Ghost Mask Input E2E Tests >> Поле «ФИО» (mask: AA AA, preset: text-separated) >> Цепочка 3: "ab cd" -> "ab cd", ""
- Location: e2e/mask-input.e2e.spec.js:827:9
