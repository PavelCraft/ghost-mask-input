...
- Name: e2e/mask-input.e2e.spec.js >> Ghost Mask Input E2E Tests >> Поле «ФИО» (mask: AA AA, preset: text-separated) >> Цепочка 6: "ab" -> "ab", " AA"
- Location: e2e/mask-input.e2e.spec.js:860:9
