...
- Name: e2e/mask-input.e2e.spec.js >> Ghost Mask Input E2E Tests >> Поле «Дублирующиеся разделители» (mask: AA AA--AA..AA, preset: text-separated) >> Цепочка 7: "ab" -> "ab", " AA--AA..AA"
- Location: e2e/mask-input.e2e.spec.js:1059:9
