...
- Name: e2e/mask-input.e2e.spec.js >> Ghost Mask Input E2E Tests >> Поле «Дублирующиеся разделители» (mask: AA AA--AA..AA, preset: text-separated) >> Цепочка 14: "ab c", курсор после пробела, "d" -> "ab dc", "--AA..AA"
- Location: e2e/mask-input.e2e.spec.js:1136:9
...
Locator:  locator('[data-mask="AA AA--AA..AA"][data-preset="text-separated"]').first().locator('..').locator('..').locator('.ghost-remaining')
Expected: "--AA..AA"
Received: "AA AA--AA..AA"
Timeout:  5000ms

Call log:
  - Expect "toHaveText" with timeout 5000ms
  - waiting for locator('[data-mask="AA AA--AA..AA"][data-preset="text-separated"]').first().locator('..').locator('..').locator('.ghost-remaining')
    2 × locator resolved to <span class="ghost-remaining"></span>
      - unexpected value ""
    7 × locator resolved to <span class="ghost-remaining">AA AA--AA..AA</span>
      - unexpected value "AA AA--AA..AA"
